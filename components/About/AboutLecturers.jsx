      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {lecturers.map((lecturer, index) => (
            ...
            >
              <div className="h-full bg-white dark:bg-white/5 backdrop-blur-sm border border-slate-200 dark:border-white/10 rounded-[2rem] p-5 shadow-sm hover:shadow-2xl hover:shadow-[#002147]/10 dark:hover:shadow-blue-500/10 transition-all duration-500 flex flex-col items-center text-center relative overflow-hidden group-hover:-translate-y-2">
                
                {/* Image Container */}
                <div className="relative w-24 h-24 mb-5 p-1 rounded-full border-2 border-dashed border-[#002147]/20 dark:border-white/20 group-hover:border-[#002147] dark:group-hover:border-blue-500 transition-colors duration-500">
                ...
                <div className="flex-1 w-full">
                  <h3 className="text-base font-bold text-slate-900 dark:text-white mb-1 tracking-tight group-hover:text-[#002147] dark:group-hover:text-blue-400 transition-colors">
                    {lecturer.name}
                  </h3>
                  <div className="text-xs text-[#002147] dark:text-blue-400 mb-3">
                    {lecturer.specialization}
                  </div>
                  <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed mb-5 line-clamp-3">
                    {lecturer.bio}
                  </p>
                </div>
